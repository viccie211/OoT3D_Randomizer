...
typedef enum {
    ...
    SPIRIT_TEMPLE_CHILD_SUN_ON_FLOOR_ROOM,
    SPIRIT_TEMPLE_EARLY_ADULT,
    SPIRIT_TEMPLE_EARLY_ADULT_WOLFOS_ROOM,
    SPIRIT_TEMPLE_EARLY_ADULT_BOULDER_ROOM,
    SPIRIT_TEMPLE_EARLY_ADULT_CHEST_ROOM,
    SPIRIT_TEMPLE_EARLY_ADULT_CLIMB,
    SPIRIT_TEMPLE_EARLY_ADULT_MIRROR_ROOM,
